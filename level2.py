...
while running:
    ...
    if player.health <= 0 or enemy.health <= 0:
        ...
        screen.blit(chest_image, (0, 0))  # Show chest2.png as a full-screen image
...
#             if event.type == pygame.QUIT:
#                 pygame.quit()
#                 return False  # Exit if the player quits
...
#             pygame.time.delay(3000)
#             running = False
#             return player.health > 0  # Return True if player wins

#         # Update display and maintain frame rate
#         pygame.display.flip()
#         clock.tick(FPS)

#     return False  # In case the loop ends and no winner is found
